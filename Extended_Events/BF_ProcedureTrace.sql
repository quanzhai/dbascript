...
SET @SessionName		= 'BF_ProcedureTrace';
SET @MaxFileSizeMb		= 100;
SET @FileNumber			= 10;
SET @StartUpState		= 'Off';
...
SET @sql ='
	...
	ADD EVENT sqlserver.rpc_completed(SET collect_statement=(1)
        ACTION(sqlserver.client_hostname,sqlserver.database_name,sqlserver.query_hash,sqlserver.sql_text,sqlserver.username)
            WHERE ([sqlserver].[equal_i_sql_unicode_string]([sqlserver].[database_name],N''Authorization'') AND [object_name]=N''Role_GetReporteeList161_SELECT''))
